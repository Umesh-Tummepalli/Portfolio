...
const Links = () => {
  ...
  return (
    <nav className="w-full md:w-1/2 overflow-hidden" aria-label="Social media links">
      <div className="flex justify-around items-center w-full" ref={divRef} role="list">
        <a
        ...
        <span className="h-0.5 w-1/6 md:w-1/4 bg-gray-500" aria-hidden="true"></span>
